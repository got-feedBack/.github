...
- [ ] Open a milestone tracking issue: **"vX.Y.Z milestone"** in `slopsmith/slopsmith` listing all planned features. Link relevant issues to it.
...
- [ ] Tag core:
  ```bash
  # In slopsmith/slopsmith, on release/vX.Y.Z
...
- [ ] Tag desktop with the same tag:
  ```bash
  # In slopsmith/slopsmith-desktop, on release/vX.Y.Z
